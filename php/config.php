...
if(LOCALHOST) {
	define('DB_USER','root');
	define('DB_NAME','brava-concetto');
	define('DB_PASS','');
	define('DB_HOST','localhost');
	define('PREFIX','adm_');
	define('ROOT',$_SERVER['DOCUMENT_ROOT'].'/brava-concetto');
	define('HTTP','http://'.$_SERVER['HTTP_HOST'].'/brava-concetto');
	define('SHIFT_NUM', 1);
...
// define('DB_PASS','XHMfhXq=GIx');
// define('DB_HOST','localhost');
// define('DB_NAME','quaxxcom_aram');
// define('PREFIX','adm_');
// define('ROOT',$_SERVER['DOCUMENT_ROOT'].'/clientes/aram');
// define('HTTP','https://'.$_SERVER['HTTP_HOST'].'/clientes/aram');
