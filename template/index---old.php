...
<!-- BANNER -->
<!-- <section class="section-banners waypoint animation_bottom_d1">
	<div 
	...
	>
		...
		<div class="li" style="background-image: url(<?=HTTP_UPLOADS_IMG.(!$MOBILE ? $rs->imagem : $rs->imagem_mobile); ?>); "></div>
...
<div class="box-video">
	<video 
		id="video" 
		class="is-block waypoint animation_bottom animated" 
		width="100%" 
		height="760" 
		autoplay loop muted playsinline preload="auto"
		poster="<?=IMG?>videos/placeholder<?=($MOBILE ? "-mobile" : "")?>.webp"
	>
		<source src="<?=IMG?>videos/aram-teaser-mobile.mp4" type="video/mp4" media="(max-width: 578px)">
		<source src="<?=IMG?>videos/aram-teaser-low.mp4" 	type="video/mp4" media="(min-width: 579px)">
...
<section class="section-block-3" id="casas">
	<div class="wrap">
 		...
 		<div class="columns is-centered is-multiline mt100 mt20-mobile mb100 mb20-mobile">

 			<div class="column is-4 has-text-centered waypoint animation_bottom mb40-mobile">
				<a href="#galeria1" class="smooth-scroll-link" data-smooth-time-link="2500">
					<div class="num m-auto mb10 waypoint animation_scale">1</div>
					<h3 class="mb10">CASA FLORA</h3>
					<h4>650,12 m² PRIVATIVOS</h4>

					<p class="mt20"> 
						4 OU 5 SUÍTES SENDO UMA MASTER<br>
						4 VAGAS DE GARAGEM
					</p>
				</a>
 			</div>
			...
			<div class="column is-4 has-text-centered waypoint animation_bottom mb40-mobile">
				<a href="#galeria1" class="smooth-scroll-link" data-smooth-time-link="2500">
					<div class="num m-auto mb10 waypoint animation_scale">2</div>
					<h3 class="mb10">CASA AURORA</h3>
					<h4>637,08 m² PRIVATIVOS</h4>
			...
			<div class="column is-4 has-text-centered waypoint animation_bottom xmb40-mobile">
				<a href="#galeria1" class="smooth-scroll-link" data-smooth-time-link="2500">
					<div class="num m-auto mb10 waypoint animation_scale">3</div>
					<h3 class="mb10">CASA ONDA</h3>
					<h4>638,63 m² PRIVATIVOS</h4>
			...
			<div class="column is-4 has-text-centered mt80 mt40-mobile waypoint animation_bottom">
				<a href="#galeria2" class="smooth-scroll-link" data-smooth-time-link="3500">
					<div class="num m-auto mb10 waypoint animation_scale">4</div>
					<h3 class="mb10">CASA BRISA</h3>
					<h4>1.169,48 m² PRIVATIVOS</h4>

					<p class="mt20"> 
						5 OU 6 SUÍTES SENDO UMA MASTER<br>
						5 VAGAS DE GARAGEM
					</p>
				</a>
 			</div>
			...
			<div class="column is-4 has-text-centered mt80 mt40-mobile waypoint animation_bottom">
				<a href="#galeria2" class="smooth-scroll-link" data-smooth-time-link="3500">
					<div class="num m-auto mb10 waypoint animation_scale">5</div>
					<h3 class="mb10">CASA SERENA</h3>
					<h4>1.159,51 m² PRIVATIVOS</h4>
			...
			<div class="column is-4 has-text-centered mt80 mt40-mobile waypoint animation_bottom">
				<a href="#galeria2" class="smooth-scroll-link" data-smooth-time-link="3500">
					<div class="num m-auto mb10 waypoint animation_scale">6</div>
					<h3 class="mb10">CASA AREIA</h3>
					<h4>1.166,73 m² PRIVATIVOS</h4>
...
<section class="section-home-contato bg-root color-gray-light" id="contato">
	<div class="wrap is-relative">
		...
		<div class="columns mt20">
			<div class="column is-6">
				<img src="<?=IMG?>angatu-logo-light.svg" alt="angatu logo" class="waypoint animation_left">
			</div>

			<div class="column is-6 has-text-right mt40 is-hidden-mobile">
				<h3 class="color-gray-light waypoint animation_right">
					VAMOS CONVERSAR?<br>
					+55 <a href="<?=LINK_WHATSAPP?>" target="_blank"><?=CELULAR?></a>
				</h3>
			</div>
		</div>
		...
		<div class="columns is-mobile is-multiline mt110 mt60-mobile">
			...
			<div class="column is-4-tablet is-12-mobile pl0 pl10-mobile waypoint animation_right mt110 mt60-mobile">

				<h3 class="is-hidden-tablet color-gray-light has-text-centered waypoint animation_right mb50">
					VAMOS CONVERSAR?<br>
					+55 <a href="<?=LINK_WHATSAPP?>" target="_blank"><?=CELULAR?></a>
				</h3>
